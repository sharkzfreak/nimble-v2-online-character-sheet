...
import { STORMSHIFTER_SUBCLASS_FEATURES } from './stormshifterFeatures';
import { ZEPHYR_SUBCLASS_FEATURES } from './zephyrFeatures';
import { HEXBINDER_SUBCLASS_FEATURES } from './hexbinderFeatures';
...
export const ALL_STORMSHIFTER_SUBCLASS_FEATURES = STORMSHIFTER_SUBCLASS_FEATURES;

export const ALL_ZEPHYR_SUBCLASS_FEATURES = ZEPHYR_SUBCLASS_FEATURES;
...
export function getSubclassFeatures(subclassId: string): SubclassFeature[] {
  const allSubclassFeatures = [
    ...
    ...STORMSHIFTER_SUBCLASS_FEATURES,
    ...ZEPHYR_SUBCLASS_FEATURES,
  ];
...
export { CHEAT_SUBCLASS_FEATURES, COMMANDER_SUBCLASS_FEATURES, HEXBINDER_SUBCLASS_FEATURES, HUNTER_SUBCLASS_FEATURES, MAGE_SUBCLASS_FEATURES, VENGEANCE_SUBCLASS_FEATURES, REFUGE_SUBCLASS_FEATURES, SHADOWMANCER_SUBCLASS_FEATURES, SHEPHERD_SUBCLASS_FEATURES, SONGWEAVER_SUBCLASS_FEATURES, STORMSHIFTER_SUBCLASS_FEATURES, ZEPHYR_SUBCLASS_FEATURES };
